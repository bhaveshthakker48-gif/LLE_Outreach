...
public class Dailywork_Report extends BaseActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    {
        //total_household = PopulationMedicalModel.gethouseholdcount(SharedPreference.get("CAMPID"),SharedPreference.get("Userid"));
        ...
        {
            //popMedicalData = PopulationMedicalModel.getdailyworkrepot(getyyyymmdd(txtbeforedate.getText().toString()), getyyyymmdd(txtcurrentdate.getText().toString()), SharedPreference.get("CAMPID"));
    ...
    public void init() {
     ...
     /*   msg.setCamp_Location("Select");
        msg.setOutreach_From("");

        outreachplandata.add(0,msg);*/
