...
public class PadalistAdapter extends ArrayAdapter<PhcUserData> {
    Context context;
    int resource,textviewid;
    List<PhcUserData> items,tempItems,suggestions;

    public PadalistAdapter(Context context, int resource, int textViewResourceId, List<PhcUserData> items) {
