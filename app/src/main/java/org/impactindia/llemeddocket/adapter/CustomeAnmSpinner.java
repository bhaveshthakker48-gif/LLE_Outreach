...
public class CustomeAnmSpinner extends BaseAdapter {
    Context context;
    ArrayList<PadanashaworkerData> userdata = new ArrayList<PadanashaworkerData>();
    LayoutInflater inflter;

    public CustomeAnmSpinner(Context context, ArrayList<PadanashaworkerData> userdata) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        names.setText(userdata.get(position).getAnmname());
        return convertView;
