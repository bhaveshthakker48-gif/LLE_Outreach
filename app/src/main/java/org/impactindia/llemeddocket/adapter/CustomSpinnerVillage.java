...
public class CustomSpinnerVillage extends BaseAdapter {
    Context context;
    ArrayList<PadanashaworkerData> userdata = new ArrayList<PadanashaworkerData>();
    LayoutInflater inflter;

    public CustomSpinnerVillage(Context context, ArrayList<PadanashaworkerData> userdata) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        names.setText(userdata.get(position).getVillage());
        return convertView;
